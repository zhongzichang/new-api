...
func GetCodexChannelUsage(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusOK, gin.H{"success": false, "message": "解析凭证failed，请检查channelconfiguration"})
		return
	}
	...
	if err != nil {
		...
		c.JSON(http.StatusOK, gin.H{"success": false, "message": "获取用量infofailed，请稍后重试"})
		return
	}
